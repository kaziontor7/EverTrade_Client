    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex flex-col md:flex-row gap-8">
        ...
        <aside className="w-full md:w-64 flex-shrink-0">
          <div className="bg-white dark:bg-gray-900/50 backdrop-blur-xl border border-gray-200 dark:border-white/10 rounded-2xl p-6 sticky top-24 shadow-2xl">
              ...
              {role === 'admin' ? (
                <>
                  ...
                  <Link 
                    ...
                    className="flex items-center space-x-3 px-4 py-3 text-gray-600 dark:text-gray-400 rounded-xl hover:bg-white/5 hover:text-gray-900 dark:text-white transition-all font-medium"
                  >

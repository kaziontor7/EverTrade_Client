  ...
  return (
    <div className="space-y-6">
      <div className="bg-gradient-to-r from-emerald-900/40 to-gray-900 border border-emerald-500/20 rounded-2xl p-8">
        ...
        <p className="text-gray-600 dark:text-gray-400 mt-2">Monitor platform activity and moderate listings.</p>
      </div>

      {/* Stats Cards */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white dark:bg-gray-900/50 backdrop-blur-xl border border-gray-200 dark:border-white/10 rounded-2xl p-6 flex flex-col items-center justify-center text-center">
        ...
        <div className="bg-white dark:bg-gray-900/50 backdrop-blur-xl border border-yellow-500/20 rounded-2xl p-6 flex flex-col items-center justify-center text-center">

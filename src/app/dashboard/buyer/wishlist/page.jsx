        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {wishlist.map(product => (
              <div key={product._id} className="bg-gray-100/60 dark:bg-black/40 border border-gray-200 dark:border-white/10 rounded-2xl overflow-hidden hover:border-emerald-500/50 transition-colors group h-full flex flex-col">
                <div className="h-48 w-full relative overflow-hidden bg-gray-200 dark:bg-gray-800">
                  ...
                  <button 
                    ...
                    className="absolute top-3 left-3 w-8 h-8 bg-white/80 dark:bg-black/60 backdrop-blur-md text-red-400 rounded-full flex items-center justify-center hover:bg-red-500 hover:text-gray-900 dark:text-white transition-colors"
                  >
                ...
                <div className="p-5 flex-1 flex flex-col">
                  ...
                  <Link href={`/products/${product._id}`} className="mt-4 w-full block text-center py-2 bg-white/5 hover:bg-emerald-500/20 hover:text-emerald-400 text-gray-900 dark:text-white rounded-xl text-sm font-medium transition-colors border border-gray-200 dark:border-white/5 hover:border-emerald-500/30">
                    View Product
                  </Link>
                </div>
              </div>

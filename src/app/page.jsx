...
export default function Home() {
  return (
    <div className="flex-grow flex flex-col min-h-screen bg-background relative overflow-hidden">
      ...
      <section className="relative z-10 pt-24 pb-20 md:pt-32 md:pb-32 px-6">
        <div className="max-w-[1440px] mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold text-on-surface tracking-tight mb-8 animate-slide-up stagger-2 leading-[1.1]">
            Give Quality Tech <br className="hidden md:block" />
            a <span className="text-gradient">Second Life.</span>
          </h1>

          <p className="text-lg md:text-xl text-on-surface-variant max-w-2xl mx-auto mb-12 animate-slide-up stagger-3 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-slide-up stagger-4">
            ...
            <Link href="/signup" className="w-full sm:w-auto">
              <button className="btn-secondary w-full py-4 px-8 text-base bg-surface-container-high/50 backdrop-blur-md">
      ...
      {/* ═══════════════════════════════════════════════════════════
          STATS BAR
          ═══════════════════════════════════════════════════════════ */}
      <section className="relative z-10 py-10 border-y border-outline/10 bg-surface/40 backdrop-blur-md">
        <div className="max-w-[1440px] mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-8 divide-x divide-outline/10">
          ...
          <div className="text-center px-4 animate-scale-in stagger-2">
            ...
            <div className="text-sm font-semibold text-on-surface-variant uppercase tracking-wider">Active Listings</div>
          </div>
          ...
          <div className="text-center px-4 animate-scale-in stagger-3">
            ...
            <div className="text-sm font-semibold text-on-surface-variant uppercase tracking-wider">Happy Users</div>
          </div>
          ...
          <div className="text-center px-4 animate-scale-in stagger-4">
            ...
            <div className="text-sm font-semibold text-on-surface-variant uppercase tracking-wider">Secure Payments</div>
          </div>
          ...
          <div className="text-center px-4 animate-scale-in stagger-5">
            ...
            <div className="text-sm font-semibold text-on-surface-variant uppercase tracking-wider">kg CO₂ Saved</div>
          </div>
        ...
        <div className="max-w-[1440px] mx-auto">
          ...
          <div className="flex justify-between items-end mb-12">
            <div>
              ...
              <p className="text-on-surface-variant">Find exactly what you're looking for.</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Link href="/products?category=laptops" className="glass-card glass-card-hover rounded-3xl p-6 group cursor-pointer h-48 flex flex-col justify-between overflow-hidden relative">
              ...
              <div className="w-12 h-12 rounded-2xl bg-surface border border-outline/20 flex items-center justify-center group-hover:border-emerald-500/50 transition-colors z-10">
                <span className="material-symbols-outlined text-2xl text-on-surface group-hover:text-emerald-400">laptop_mac</span>
              </div>
              <div className="z-10">
                <h3 className="text-xl font-bold text-on-surface mb-1 group-hover:text-emerald-400 transition-colors">Laptops</h3>
                <p className="text-sm text-on-surface-variant">MacBooks, Windows PCs</p>
              </div>
            </Link>
            ...
            <Link href="/products?category=phones" className="glass-card glass-card-hover rounded-3xl p-6 group cursor-pointer h-48 flex flex-col justify-between overflow-hidden relative">
              ...
              <div className="w-12 h-12 rounded-2xl bg-surface border border-outline/20 flex items-center justify-center group-hover:border-lime-500/50 transition-colors z-10">
                <span className="material-symbols-outlined text-2xl text-on-surface group-hover:text-lime-400">smartphone</span>
              </div>
              <div className="z-10">
                <h3 className="text-xl font-bold text-on-surface mb-1 group-hover:text-lime-400 transition-colors">Smartphones</h3>
                <p className="text-sm text-on-surface-variant">iPhones, Androids</p>
              </div>
            </Link>
            ...
            <Link href="/products?category=audio" className="glass-card glass-card-hover rounded-3xl p-6 group cursor-pointer h-48 flex flex-col justify-between overflow-hidden relative">
              ...
              <div className="w-12 h-12 rounded-2xl bg-surface border border-outline/20 flex items-center justify-center group-hover:border-cyan-500/50 transition-colors z-10">
                <span className="material-symbols-outlined text-2xl text-on-surface group-hover:text-cyan-400">headphones</span>
              </div>
              <div className="z-10">
                <h3 className="text-xl font-bold text-on-surface mb-1 group-hover:text-cyan-400 transition-colors">Audio</h3>
                <p className="text-sm text-on-surface-variant">Headphones, Speakers</p>
              </div>
            </Link>
            ...
            <Link href="/products?category=accessories" className="glass-card glass-card-hover rounded-3xl p-6 group cursor-pointer h-48 flex flex-col justify-between overflow-hidden relative">
              ...
              <div className="w-12 h-12 rounded-2xl bg-surface border border-outline/20 flex items-center justify-center group-hover:border-purple-500/50 transition-colors z-10">
                <span className="material-symbols-outlined text-2xl text-on-surface group-hover:text-purple-400">watch</span>
              </div>
              <div className="z-10">
                <h3 className="text-xl font-bold text-on-surface mb-1 group-hover:text-purple-400 transition-colors">Wearables</h3>
                <p className="text-sm text-on-surface-variant">Smartwatches, Fitness trackers</p>
              </div>
            </Link>
